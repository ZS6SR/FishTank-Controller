...
rrdtool graph /home/pi/ftc/public/imgs/waterTemp_2days.png -s 'now-2d' -e 'now' -w '1000' -h '400' \
-u 30 -t 'Water Temperature for Last 2 Days' -v 'Celsius' \
DEF:watertemp=/home/pi/ftc/public/rrd/waterTemp.rrd:watertemp:AVERAGE \
...
rrdtool graph /home/pi/ftc/public/imgs/waterTemp_2weeks.png -s 'now-2w' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/waterTemp_2months.png -s 'now-2m' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/waterTemp_2years.png -s 'now-2y' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/humidity_2days.png -s 'now-2d' -e 'now' -w '1000' -h '400' \
-u 30 -t 'Humidity for Last 2 Days' -v 'Percentage' \
DEF:humidity=/home/pi/ftc/public/rrd/humidity.rrd:humidity:AVERAGE \
...
rrdtool graph /home/pi/ftc/public/imgs/humidity_2weeks.png -s 'now-2w' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/humidity_2months.png -s 'now-2m' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/humidity_2years.png -s 'now-2y' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/pressure_2days.png -s 'now-2d' -e 'now' -w '1000' -h '400' \
-u 30 -t 'Barometric Pressure for Last 2 Days' -v 'hPa' \
DEF:actualPress=/home/pi/ftc/public/rrd/pressure.rrd:actualPress:AVERAGE \
DEF:mslPress=/home/pi/ftc/public/rrd/pressure.rrd:mslPress:AVERAGE \
...
rrdtool graph /home/pi/ftc/public/imgs/pressure_2weeks.png -s 'now-2w' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/pressure_2months.png -s 'now-2m' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/pressure_2years.png -s 'now-2y' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/roomTemp_2days.png -s 'now-2d' -e 'now' -w '1000' -h '400' \
-u 30 -t 'Room Temperatures for Last 2 Days' -v 'Celsius' \
DEF:roomtemp1=/home/pi/ftc/public/rrd/roomTemps.rrd:roomtemp1:AVERAGE \
DEF:roomtemp2=/home/pi/ftc/public/rrd/roomTemps.rrd:roomtemp2:AVERAGE \
...
rrdtool graph /home/pi/ftc/public/imgs/roomTemp_2weeks.png -s 'now-2w' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/roomTemp_2months.png -s 'now-2m' -e 'now' -w '1000' -h '400' \
...
rrdtool graph /home/pi/ftc/public/imgs/roomTemp_2years.png -s 'now-2y' -e 'now' -w '1000' -h '400' \
